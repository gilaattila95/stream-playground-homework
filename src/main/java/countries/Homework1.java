...
public class Homework1 {
    ...
    public void streamPipeline3() {
        ...
        countries.stream().filter(country -> country.getName().toLowerCase().charAt(0) == country.getName().toLowerCase().charAt(country.getName().length() - 1)).forEach(System.out::println);
